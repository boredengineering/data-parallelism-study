...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        # len(train_loader) provides the number of batches per epoch. args.batch_size is the input
        ...
        print("Epoch = {:2d}: Epoch Time = {:5.3f}, Validation Loss = {:5.3f}, Validation Accuracy = {:5.3f}, Images/sec = {}".format(epoch+1, epoch_time, v_loss, val_accuracy[-1], images_per_sec))
